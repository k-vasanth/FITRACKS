...
coll.addEventListener('change', function(){
    ...
    if(this.checked){
        ...
        setTimeout(function(){
            document.getElementById("nav1").innerHTML=H+"Home";
            document.getElementById("nav2").innerHTML=E+"Exercises";
            document.getElementById("nav3").innerHTML=W+"Workout Routines";
        }, 620);
    }
    else{
        // console.log('bye');
        document.getElementById("sidebar").id='Sidebar';
        document.getElementById("nav1").innerHTML=H;
        document.getElementById("nav2").innerHTML=E;
        document.getElementById("nav3").innerHTML=W;
    }
})